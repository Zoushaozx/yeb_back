...
import com.zoux.server.utils.AdminUtils;
import com.zoux.server.config.security.component.JwtTokenUtil;
import com.zoux.server.mapper.AdminRoleMapper;
...
public class AdminServiceImpl extends ServiceImpl<AdminMapper, Admin> implements IAdminService {
    ...
    @Override
    @Transactional
    public RespBean updateAdminOfRole(Integer adminId, Integer[] rids) {
        adminRoleMapper.delete(new QueryWrapper<AdminRole>().eq("adminId", adminId));
        Integer result = adminRoleMapper.addAdminOfRole(adminId, rids);
